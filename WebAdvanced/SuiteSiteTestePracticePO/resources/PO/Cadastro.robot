...
${CADASTRO_MYSTORE_TITLE}           My account - My Store
${CADASTRO_MSG_MYSTORE}             xpath=//*[@id="center_column"]/p
${CADASTRO_USER_NAME}               xpath=//*[@id="header"]/div[2]//div[1]/a/span
...
Conferir se o cadastro foi efetuado com sucesso
    Wait Until Element Is Visible       ${CADASTRO_MSG_MYSTORE}
    Title Should Be                     ${CADASTRO_MYSTORE_TITLE}
    Element Text Should Be              ${CADASTRO_MSG_MYSTORE}
    ...                                 Welcome to your account. Here you can manage all of your personal information and orders.
    Element Text Should Be              ${CADASTRO_USER_NAME}                                           Rapha Carvalho
